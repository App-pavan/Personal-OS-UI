...
export const taskIconBtn =
  "grid size-8 place-items-center rounded-md border border-[var(--task-border-subtle)] bg-[var(--task-surface-secondary)] text-[var(--task-text-secondary)] transition-[color,background-color,border-color,box-shadow,transform] duration-150 hover:border-[var(--task-border)] hover:bg-[var(--task-hover)] hover:text-[var(--task-text)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--task-focus-ring)] active:scale-[0.97]";

export const taskSegmented =
  "inline-flex items-center rounded-lg border border-[var(--task-border-subtle)] bg-[var(--task-surface-secondary)] p-0.5";
...
export const taskEyebrow =
  "text-[10px] font-semibold uppercase tracking-[0.18em] text-[var(--task-accent)]";

export const taskPageTitle =
  "text-[1.625rem] font-semibold leading-tight tracking-[-0.02em] text-[var(--task-text)] sm:text-[1.875rem]";

export const taskWorkspaceMax = "mx-auto w-full max-w-[980px]";
