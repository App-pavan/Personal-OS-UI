...
import { Can, useCan } from "@/features/capabilities/can";
...
function HomePage() {
  ...
  const showChecklists = can(PERM.CHECKLISTS_VIEW);
  ...
  const todayOpen = useMemo(() => open.filter((t) => isDueToday(t) || isOverdue(t)), [open]);
  ...
  const hasWidgets = showTasks || showChecklists;
    ...
    <div className="mx-auto w-full max-w-[1500px]">
      ...
      {hasWidgets ? (
        <div className="mt-5 grid gap-4 lg:grid-cols-12">
          ...
          {showChecklists && (
            <div className={cn("space-y-4", showTasks ? "lg:col-span-5" : "lg:col-span-12")}>
