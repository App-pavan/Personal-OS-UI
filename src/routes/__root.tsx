  ...
  return (
    <div className="ambient-canvas flex min-h-screen items-center justify-center px-4">
      <div className="surface-raised max-w-md p-10 text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold">Module not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This part of your OS doesn't exist yet.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="gradient-primary inline-flex items-center justify-center rounded-2xl px-5 py-2.5 text-sm font-semibold text-primary-foreground"
          >
            Back to dashboard
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Personal OS — Your life, organized" },
      {
        name: "description",
        content:
          "Personal OS is a unified, premium workspace for tasks, finance, documents, family, storage and AI.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Public+Sans:ital,wght@0,300..800;1,400&display=swap",
      },
